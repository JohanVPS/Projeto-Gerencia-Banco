...
public class ContaDAO extends BancoDBManager {
    ...
    public static void DeletarContaDoBanco(int numeroDaConta) throws SQLException{
        try{
            preStmt = conexao.prepareStatement("DELETE FROM tab_cliente WHERE num_conta = ?");
    ...
    public static void ModificarSenhaNoBanco(int numeroDaConta, String novaSenha) throws SQLException{
        try{
            preStmt = conexao.prepareStatement("UPDATE tab_cliente SET senha = ? WHERE num_conta = ?");
            preStmt.setString(1, novaSenha);
            preStmt.setInt(2, numeroDaConta);
    ...
    public static void ModificarSaldoNoBanco(int numeroDaConta, double novoSaldo) throws SQLException{
        try{
            preStmt = conexao.prepareStatement("UPDATE tab_cliente SET saldo = ? WHERE num_conta = ?");
            preStmt.setDouble(1, novoSaldo);
            preStmt.setInt(2, numeroDaConta);
